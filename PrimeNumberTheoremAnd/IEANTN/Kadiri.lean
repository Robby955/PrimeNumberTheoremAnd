...
/-- Continuity of the shifted Laplace transform on the finite vertical segment
used in the `I_1` and `I_2` contour terms. The decay hypothesis is used only
to get integrability on the reflected positive line. -/
